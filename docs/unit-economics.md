# Golden Coffee — Unit Economics & Hardware Costing

*For the hackathon judges. Prepared 2026-06-20. All figures GBP, ex-VAT.*

Golden Coffee uses a **WHOOP-style membership model**: one flat price, the hardware is
...
| Capability | DIY (buy separately) | Golden Coffee |
|---|---|---|
...
Golden Coffee is roughly **half the monthly cost, zero upfront**, and is the only option
